...
function renderTestTable() {
  ...
  if (mobile) {
    sorted.forEach(function (t) {
      ...
      (function (id) { db.addEventListener('click', function () { playSound('click'); data.tests = data.tests.filter(function (x) { return x.id !== id; }); saveData(); renderTestTable(); }); })(t.id);
    ...
    sorted.forEach(function (t) {
      ...
      (function (id) {
        tr.querySelector('.test-del').addEventListener('click', function () { playSound('click'); data.tests = data.tests.filter(function (x) { return x.id !== id; }); saveData(); renderTestTable(); });
